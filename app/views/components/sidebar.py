...
from views.ui.theme import LightPalette, NAV_ITEMS
...
class Sidebar(ft.Container):
    ...
    def _build(self):
        # Access T dynamically to get current theme at build time
        T = theme.T
        ...
        logo = ft.Container(
            ...
            border=ft.Border(bottom=ft.BorderSide(0.5, T.DIVIDER)),
        )
        ...
        for label, icon, key, _idx in NAV_ITEMS:
            ...
            icon_color = T.PRIMARY if active else T.SIDEBAR_ICON
            text_color = T.PRIMARY if active else T.SIDEBAR_TEXT
            bg = T.PRIMARY_LIGHT if active else "transparent"
                        ...
                        [
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Text(
                                        "Control Total", color=T.SIDEBAR_TEXT, size=10
                                    ),
                                ],
                                spacing=0,
                            )
